...
(function() {
	...
	jQuery.fn = jQuery.prototype = {
		init : function(selector, context) {
			...
			return this.setArray(jQuery.isArray(selector) ? selector : jQuery
					.makeArray(selector));
		},
		...
		find : function(selector) {
			if (this.length === 1) {
				...
				return this.pushStack(jQuery.unique(jQuery.map(this, function(
						elem) {
		...
		html : function(value) {
			return value === undefined ? (this[0] ? this[0].innerHTML.replace(
		...
		domManip : function(args, table, callback) {
			if (this[0]) {
				var fragment = (this[0].ownerDocument || this[0])
						...
						(this[0].ownerDocument || this[0]), fragment), first = fragment.firstChild;
	...
	(function() {
		...
		if (document.documentElement.compareDocumentPosition) {
			...
			sortOrder = function(a, b) {
				...
				var ret = aRange.compareBoundaryPoints(Range.START_TO_END,
						bRange);
				if (ret === 0) {
					hasDuplicate = true;
				}
	...
	jQuery.each([ "Height", "Width" ], function(i, name) {
		...
		jQuery.fn["inner" + name] = function() {
			return this[0] ? jQuery.css(this[0], lower, false, "padding")
					: null;
		};

		// outerHeight and outerWidth
		jQuery.fn["outer" + name] = function(margin) {
			return this[0] ? jQuery.css(this[0], lower, false,
