                            ...
                            <div class="panel-body-padd">
                                <form role="form" action="../inc/registerDo.php" method="POST" onsubmit="" onload="return onLoadPage();">
                                    <div class="form-group">
                                        ...
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['presentation']); ?></label>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Nome:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['full_name']); ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Email:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['user_email']); ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Endereço:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['address']); ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Cidade:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['city']); ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Estado:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['state']); ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>País:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['country']); ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Telefone:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['telephone']); ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Celular:</label>
                                        <label style="font-weight: normal;"><?php print($rowValuesProfile['cellphone']); ?></label>
                                    </div>
                                </form>
                            </div>
                        </div>
